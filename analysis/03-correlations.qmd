---
title: "Correlation analysis of Ventromedial hypothalamus astrocytes dataset from Liu M et al 2022"
...
```{r params}
bioproject <- "PRJNA798401"
project <- "liu2022-VMHvl"
cb_fpr <- 0.001
low_cutoff_gene <- 500
high_cutoff_gene <- NULL
high_cutoff_gene <- 7500
low_cutoff_umis <- NULL
low_cutoff_umis <- 1000
high_cutoff_umis <- 40000
...
## Load selected astrocytes data from Liu M et al 2022
...
plt_grp_ggcorrmat <- grouped_ggcorrmat(
  ...
  annotation.args = list(
    ...
    caption = "Dataset: subset of astrocytes from the Ventromedial hypothalamus of the mouse hypothalamus (Liu M et al 2022)"
  )
)
